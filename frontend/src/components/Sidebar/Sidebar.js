...
const Sidebar = ({ role, isOpen, onToggle }) => {
    ...
    switch (role) {
      case 'student':
        return [
          ...
          { path: '/student/courses', label: 'My Courses', icon: 'courses' },
          { path: '/student/enrollment', label: 'Enrollment', icon: 'book-open' },
          { path: '/student/lessons', label: 'Lessons', icon: 'lessons' },
          { path: '/student/quizzes', label: 'Quizzes', icon: 'quizzes' },
          { path: '/student/progress', label: 'Progress', icon: 'progress' },
          { path: '/student/certificates', label: 'Certificates', icon: 'certificates' },
          { path: '/student/chat', label: 'Chat', icon: 'chat', exact: false },
          { path: '/student/settings', label: 'Settings', icon: 'settings' },
        ];
      case 'instructor':
        return [
          { path: '/instructor/dashboard', label: 'Dashboard', icon: 'dashboard' },
          { path: '/instructor/courses', label: 'My Courses', icon: 'courses' },
          { path: '/instructor/lessons', label: 'Lessons', icon: 'lessons' },
          { path: '/instructor/quizzes', label: 'Quizzes', icon: 'quizzes' },
          { path: '/instructor/students', label: 'Students', icon: 'students' },
          { path: '/instructor/analytics', label: 'Analytics', icon: 'analytics' },
          { path: '/instructor/chat', label: 'Chat', icon: 'chat', exact: false },
      ...
      case 'admin':
        return [
          ...
          { path: '/admin/lessons', label: 'Lessons', icon: 'lessons' },
          { path: '/admin/quizzes', label: 'Quizzes', icon: 'quizzes' },
          { path: '/admin/certificates', label: 'Certificates', icon: 'certificates' },
  ...
  const isActive = (path) => {
    if (path === '/student/chat' || path === '/instructor/chat') {
